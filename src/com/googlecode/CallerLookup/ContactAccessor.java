...
public abstract class ContactAccessor {
    ...
    public static ContactAccessor getInstance() {
        if (sInstance == null) {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                className = "com.googlecode.CallerLookup.ContactAccessorSdk3_4";
            } else {
                className = "com.googlecode.CallerLookup.ContactAccessorSdk5";
            }
    ...
    /**
     * Search contact's phone number for the supplied URI. The actual queries will differ for different APIs
     * used, but the result is the same: the {@link #mDisplayName} is populated with correct data.
     */
    public abstract String findPhoneNumber(ContentResolver contentResolver, String phoneNumber);
